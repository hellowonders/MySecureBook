package com.qdt.blockchain.fx.progress;
...
//        daysLabel.setText("\n\n\n\n\nRemaining\n     Days");
        ...
        container.getChildren().addAll(fillerArc, outerCircle, innerCircle, percentLabel, daysLabel);
    }
    ...
    private void initFillerArc() {
        ...
        fillerArc.setLength(indicator.getProgress());
    }
